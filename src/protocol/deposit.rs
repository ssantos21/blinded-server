...
use crate::{shared::{DepositMsg1, UserID, DepositMsg2, StatechainID}, error, server::StateChainEntity, schema, storage::db::MercuryPgDatabase};
...
pub trait Deposit {
    ...
    fn deposit_confirm(&self, deposit_msg2: DepositMsg2) -> Result<StatechainID, error::SEError>;
}
